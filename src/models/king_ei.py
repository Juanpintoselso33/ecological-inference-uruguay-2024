...
class KingEI(BaseEIModel):
    ...
    def _save_trace(self, origin_cols, destination_cols):
        """Save InferenceData trace to pickle. Called automatically after sampling."""
        ...
        try:
            ...
            fname = f"kingei_{self.likelihood}_{n_origin}x{n_dest}_{self.num_samples}s_{self.num_chains}c.pkl"
    ...
    def load_trace(cls, trace_path: str, **kwargs) -> 'KingEI':
        ...
        Args:
            trace_path: Path to .pkl file saved by _save_trace()
