...
\input{../../outputs/tables/latex/national_transition_matrix_pi}
...
Los circuitos electorales clasificados como rurales demostraron tasas marcadamente más altas de defección de la coalición hacia el Frente Amplio en comparación con los circuitos urbanos. La Tabla~\ref{tab:urban_rural_pi} presenta las probabilidades de transición estimadas estratificadas por nivel de urbanización para los cuatro partidos principales de la coalición (CA, PC, PI, PN).

% Comparación urbano-rural
\input{../../outputs/tables/latex/urban_rural_comparison_table_pi}

\textbf{Cabildo Abierto.} Los circuitos rurales exhibieron una probabilidad de transición CA$\to$FA del 60.8\% (IC 95\%: [51.7\%, 69.8\%]), mientras que los circuitos urbanos mostraron un 39.0\% (IC 95\%: [35.1\%, 42.8\%]). La diferencia de 21.8 puntos porcentuales es sustancial y estadísticamente significativa, como lo indican los intervalos de credibilidad del 95\% no superpuestos. Este patrón contradice la sabiduría convencional sobre el comportamiento político rural en Uruguay. Los relatos tradicionales de la geografía electoral uruguaya enfatizan el conservadurismo rural y un apego más fuerte al Partido Nacional, particularmente en el interior agrícola \citep{gonzalez1991electoral}. Los hallazgos sugieren que los votantes rurales de CA tenían \textit{más}, no menos, probabilidades de defectar al Frente Amplio.

\textbf{Partido Colorado.} La brecha rural-urbana fue aún más pronunciada para los votantes del PC. Los circuitos rurales mostraron un 18.2\% de defección PC$\to$FA (IC 95\%: [16.2\%, 20.1\%]) comparado con solo un 5.2\% en áreas urbanas (IC 95\%: [4.1\%, 6.3\%])---un multiplicador de 3.5 veces. Esta dramática tasa de defección rural del PC, combinada con la sustancial base de primera vuelta del partido (387,125 votos), convirtió a los votantes del Colorado en áreas rurales en una fuente crítica de ganancias para el FA. Dada la fortaleza histórica del PC en centros urbanos y su posicionamiento ideológico moderado, el éxodo rural sugiere una profunda insatisfacción con las políticas agrícolas y de desarrollo rural de la coalición.

\textbf{Partido Nacional.} En contraste con los patrones de CA y PC, los votantes del PN mostraron tasas de defección prácticamente idénticas a través de los estratos de urbanización. Los circuitos urbanos exhibieron un 6.9\% de defección PN$\to$FA (IC 95\%: [6.3\%, 7.5\%]) versus un 7.0\% en circuitos rurales (IC 95\%: [5.8\%, 8.2\%]). Esta consistencia sugiere que los votantes del Nacional mantuvieron una lealtad relativamente uniforme independientemente del contexto geográfico, aunque ambas tasas indican defecciones significativas desde el PN hacia el ideológicamente distante FA. La consistencia rural-urbana del PN contrasta marcadamente con los patrones de CA y PC, posiblemente reflejando las raíces organizacionales más profundas del partido Nacional tanto en áreas urbanas como rurales.

La Figura~\ref{fig:urban_rural_forest} visualiza estos resultados a través de un gráfico de bosque que compara las probabilidades de transición a través de los orígenes partidarios. La rebelión rural contra la coalición no fue uniforme---se concentró más fuertemente en los votantes de CA y PC, con votantes rurales del PC defectando a 3.5 veces la tasa urbana. Esta insatisfacción geográficamente concentrada con las políticas de centro-derecha en el campo probablemente refleja fracasos en políticas agrícolas, subinversión en infraestructura rural, o un sesgo urbano percibido en la gobernanza de la coalición.

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{urban_rural_ca_defection_forest.png}
\caption{Gráfico de bosque comparando tasas de defección de la coalición urbanas y rurales. Los puntos representan medias posteriores con intervalos de credibilidad del 95\%. Los circuitos rurales (rojo) muestran consistentemente tasas de defección más altas que los circuitos urbanos (azul) en todos los partidos de la coalición, con la mayor diferencia observada para los votantes de Cabildo Abierto (60.8\% rural vs.\ 39.0\% urbano, diferencia de 21.8 pp).}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\textwidth]{all_coalition_parties_comparison.png}
...
La Tabla~\ref{tab:region_pi} presenta las probabilidades de transición estratificadas por región para los cuatro partidos principales de la coalición (CA, PC, PI, PN), revelando patrones consistentes de mayor defección interior a través de todos los partidos pero con magnitudes variadas.

% Comparación metropolitano-interior
\input{../../outputs/tables/latex/region_comparison_table_pi}

\textbf{Cabildo Abierto.} Los circuitos del interior exhibieron un 54.7\% de defección CA$\to$FA (IC 95\%: [50.3\%, 59.1\%]) comparado con un 23.2\% en el Área Metropolitana (IC 95\%: [17.4\%, 28.8\%]). Esta diferencia de 31.5 puntos porcentuales representa un cambio sustancial en el comportamiento político, sugiriendo que el atractivo de CA fue marcadamente más débil fuera de la región capital. La mayor tasa de defección del interior se alinea con reportes del período de campaña sobre insatisfacción de votantes del interior con la gobernanza de la coalición, particularmente respecto a precios agrícolas, infraestructura rural y desarrollo económico regional \citep{uruguay2024campaign}.

\textbf{Partido Colorado.} El PC exhibió una brecha metropolitano-interior sustancial. Los circuitos del interior mostraron un 10.3\% de defección PC$\to$FA (IC 95\%: [9.2\%, 11.3\%]) versus un 3.8\% en el área metropolitana (IC 95\%: [2.1\%, 5.2\%]). Esta diferencia de 6.5 puntos porcentuales, aunque menor que la brecha de CA, es significativa dado la gran base electoral del PC. La tasa de defección del PC en el interior, casi tres veces superior a la metropolitana, sugiere que los votantes del Colorado en áreas provinciales se sintieron menos vinculados a la coalición que sus homólogos metropolitanos. Dada la fortaleza tradicional del PC en Montevideo y su posición ideológica moderada, este éxodo interior indica insatisfacción que trascendió la lealtad partidaria en contextos provinciales.

\textbf{Partido Nacional.} El análisis regional revela el patrón más dramático en las defecciones del PN. Las transiciones PN$\to$FA en el interior alcanzaron un 6.9\% (IC 95\%: [6.3\%, 7.5\%]), comparado con un negligible 0.3\% (IC 95\%: [0.0\%, 1.1\%]) en el Área Metropolitana. Esto representa una diferencia de 23 veces---los votantes del PN del interior defeccionaron al Frente Amplio a una tasa 23 veces mayor que los votantes del PN metropolitanos. Dado la identidad histórica del Partido Nacional como el partido del interior y del Uruguay rural \citep{gonzalez1993structuring}, este patrón de deserción constituye una reversión dramática. Sugiere que incluso los votantes tradicionales del Nacional---el núcleo ideológico del partido---abandonaron la coalición en las provincias, probablemente reflejando una profunda insatisfacción con el desempeño de la coalición en temas centrales para los medios de vida del interior.

La Figura~\ref{fig:region_comparison} muestra visualmente estos contrastes regionales, destacando el rol del interior como epicentro del declive de la coalición en todos los partidos. El área metropolitana, beneficiándose de mayor dinamismo económico y empleo más diversificado, puede haber aislado a los votantes de la coalición de la insatisfacción que impulsó las defecciones del interior.

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{region_coalition_defections.png}
...
\input{../../outputs/tables/latex/department_top10_table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{department_ca_defection_map.png}
...
\input{../../outputs/tables/latex/department_pc_top10_table}
...
\input{../../outputs/tables/latex/department_pn_top10_table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{coalition_defection_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{coalition_vote_impact.png}
...
\input{../../outputs/tables/latex/mcmc_diagnostics_table}
